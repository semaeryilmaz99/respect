// Spotify Sync Service Role Test - Bu kodu browser console'a kopyalayıp yapıştırın
...
async function spotifySyncServiceRoleTest() {
  try {
    console.log('🔧 Spotify Sync Service Role Test Başlıyor...');
    ...
    // 4. Service Role ile Edge Function'ı test et
    console.log('🔧 Service Role ile Edge Function test ediliyor...');
    ...
    if (functionResponse.ok) {
      ...
      if (functionData.success) {
        ...
        // Debug: Eğer hala hata varsa, tüm bağlantıları kontrol et
        if (functionData.error === 'Spotify connection not found') {
          console.log('🔍 Debug: Tüm spotify_connections tablosunu kontrol ediliyor...');
